...
Tags: currency conversion, south african payment gateway, payment gateway, payu, PayU South Africa, PayU MEA, woocommerce, Woocommerce PayU, Woocommerce PayU South Africa
Tested up to: 4.5.2
Stable tag: 1.0
...
1. Upload `payuMeaRppWooCommerce` directory to the `/wp-content/plugins/` directory
